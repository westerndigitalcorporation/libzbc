...
static struct zbc_sg_cmd_s
{
	...
	{
		"DOMAIN REPORT",
		ZBC_SG_DOMAIN_REPORT_CDB_OPCODE,
		ZBC_SG_DOMAIN_REPORT_CDB_SA,
		ZBC_SG_DOMAIN_REPORT_CDB_LENGTH,
		SG_DXFER_FROM_DEV
	},
	...
	{
		"ZONE ACTIVATE (16)",
		ZBC_SG_ZONE_QUERY_CVT_16_CDB_OPCODE,
		ZBC_SG_ZONE_ACTIVATE_16_CDB_SA,
		ZBC_SG_ZONE_QUERY_CVT_16_CDB_LENGTH,
		SG_DXFER_FROM_DEV
	},
	...
	{
		"ZONE ACTIVATE (32)",
		ZBC_SG_ZONE_QUERY_CVT_32_CDB_OPCODE,
		ZBC_SG_ZONE_ACTIVATE_32_CDB_SA,
		ZBC_SG_ZONE_QUERY_CVT_32_CDB_LENGTH,
		SG_DXFER_FROM_DEV
	},
