...
static struct zbc_sg_cmd_s
{
	...
	{
		"MEDIA CONVERT (16)",
		ZBC_SG_MEDIA_QUERY_CVT_16_CDB_OPCODE,
		ZBC_SG_MEDIA_CONVERT_16_CDB_SA,
		ZBC_SG_MEDIA_QUERY_CVT_16_CDB_LENGTH,
		SG_DXFER_FROM_DEV
	},
	...
	[ZBC_SG_MEDIA_CONVERT_32] =
	{
		...
		ZBC_SG_MEDIA_QUERY_CVT_32_CDB_LENGTH,
		SG_DXFER_FROM_DEV
	},
