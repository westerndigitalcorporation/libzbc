...
static struct zbc_sg_cmd_s
{
	...
	{
		"MEDIA REPORT",
		ZBC_SG_MEDIA_REPORT_CDB_OPCODE,
		ZBC_SG_MEDIA_REPORT_CDB_SA,
		ZBC_SG_MEDIA_REPORT_CDB_LENGTH,
		SG_DXFER_FROM_DEV
	},
	...
	{
		"MEDIA CONVERT (16)",
		ZBC_SG_MEDIA_CONVERT_16_CDB_OPCODE,
		0,
		ZBC_SG_MEDIA_CONVERT_16_CDB_LENGTH,
		SG_DXFER_FROM_DEV
	},
	...
	{
		"MEDIA QUERY (16)",
		ZBC_SG_MEDIA_QUERY_16_CDB_OPCODE,
		0,
		ZBC_SG_MEDIA_QUERY_16_CDB_LENGTH,
		SG_DXFER_FROM_DEV
	},
	...
	{
		"MEDIA CONVERT (32)",
		ZBC_SG_MEDIA_QUERY_CVT_32_CDB_OPCODE,
		ZBC_SG_MEDIA_CONVERT_32_CDB_SA,
		ZBC_SG_MEDIA_CONVERT_32_CDB_LENGTH,
		SG_DXFER_FROM_DEV
	},
	...
	[ZBC_SG_MEDIA_QUERY_32] =
	{
		"MEDIA QUERY (32)",
		ZBC_SG_MEDIA_QUERY_CVT_32_CDB_OPCODE,
		ZBC_SG_MEDIA_QUERY_32_CDB_SA,
		ZBC_SG_MEDIA_QUERY_32_CDB_LENGTH,
		SG_DXFER_FROM_DEV
	},
	...
	[ZBC_SG_CONVERT_REALMS] =
	{
		...
		ZBC_SG_CONVERT_REALMS_CDB_SA,
		ZBC_SG_CONVERT_REALMS_CDB_LENGTH,
		SG_DXFER_NONE
	},
