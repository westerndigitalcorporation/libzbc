 ...
 */
#define ZBC_SG_REPORT_ZONE_DOMAINS_CDB_OPCODE	0x95 /* FIXME opcode TBD */
 ...
 */
#define ZBC_SG_REPORT_REALMS_CDB_OPCODE		0x95 /* FIXME opcode TBD */
 ...
 */
#define ZBC_SG_ZONE_QUERY_ACTV_16_CDB_OPCODE	0x95 /* FIXME value TBD */
#define ZBC_SG_ZONE_QUERY_ACTV_32_CDB_OPCODE	0x7F /* FIXME value TBD */
...
extern int zbc_sg_cmd_init(struct zbc_device *dev,
			   ...
			   uint8_t const *out_buf, size_t out_bufsz);
 ...
 */
extern void zbc_sg_print_bytes(struct zbc_device *dev, uint8_t const *buf,
			       unsigned int len);
