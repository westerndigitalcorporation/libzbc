...
# Test print
echo -n "    ${testname}: REPORT_ZONES invalid field in cdb test (illegal value in reporting option)... "
...
# Start testing
report_option=10
sudo ${bin_path}/zbc_test_report_zones -v -ro ${report_option} ${device} >> ${log_file} 2>&1
