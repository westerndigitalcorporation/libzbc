...
zbc_test_init $0 "CLOSE ZONE-ID > max_lba ignored when ALL bit is set" $*
...
# Attempt CLOSE ALL, specifying a bad LBA which is expected to be IGNORED
zbc_test_run ${bin_path}/zbc_test_close_zone --ALL ${device} $(( ${max_lba} + 2 ))
