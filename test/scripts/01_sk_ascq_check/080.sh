...
zbc_test_init $0 "READ cross-zone FULL->OPEN ending above Write Pointer (type=${test_zone_type:-${ZT_SEQ}})" $*
...
expected_asc="Attempt-to-read-invalid-data"	# because second zone has limited data
