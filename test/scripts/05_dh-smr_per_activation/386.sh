...
# Find a SBR domain that is convertible to sequential
...
zbc_test_get_zone_from_slba ${domain_conv_start}
...
zbc_test_run ${bin_path}/zbc_test_write_zone ${device} ${domain_conv_start} ${target_size}
