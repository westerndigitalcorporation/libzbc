...
zbc_test_init $0 "ZONE ACTIVATE(32): deactivate CLOSED partly-written sequential zone" $*
...
# Make the first zone of the realm non-empty and closed
...
zbc_test_run ${bin_path}/zbc_test_close_zone ${device} $(zbc_realm_smr_start)
zbc_test_get_sk_ascq
zbc_test_fail_if_sk_ascq "Initial CLOSE failed at $(zbc_realm_smr_start) zone_type=${smr_type}"
