...
zbc_test_init $0 "ZONE ACTIVATE${zbc_test_actv_flags}: deactivate CLOSED SWR or SWP zone" $*
...
zbc_test_run ${bin_path}/zbc_test_close_zone -v ${device} ${seq_lba}
zbc_test_fail_exit_if_sk_ascq "Initial CLOSE lba=${seq_lba} zone_type=${smr_type}"
