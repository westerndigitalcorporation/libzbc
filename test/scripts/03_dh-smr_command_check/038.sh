...
zbc_test_init $0 "ZONE ACTIVATE(16): all CMR to SMR (realm addressing, FSNOZ)" $*
...
# Assume that all realms that can be activated are contiguous
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -n ${device} ${realm_num} ${nr_actv_as_seq_realms} ${smr_type}
