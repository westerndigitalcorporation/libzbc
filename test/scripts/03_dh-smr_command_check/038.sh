...
zbc_test_init $0 "ZONE ACTIVATE(16): all CMR to SMR (domain addressing, FSNOZ)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -n ${device} ${domain_num} ${nr_cvt_to_seq_domains} ${smr_type}
