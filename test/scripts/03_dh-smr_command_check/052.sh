...
zbc_test_init $0 "ZONE ACTIVATE(32): all CMR to SMR (realm addressing)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -32 ${device} ${realm_num} ${actv_realms} ${smr_type}
