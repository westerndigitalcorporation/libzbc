...
zbc_test_init $0 "MEDIA CONVERT(32) non-convertible SMR domain to CMR (domain addressing)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_media_convert -v -32 ${device} ${domain_num} 1 "conv"
