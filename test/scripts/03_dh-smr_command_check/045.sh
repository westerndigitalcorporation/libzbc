...
zbc_test_init $0 "ZONE ACTIVATE(16): all SMR to CMR (zone addressing, FSNOZ)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -z -n ${device} ${domain_seq_start} ${nr_seq_zones}  ${cmr_type}
