...
zbc_test_init $0 "ZONE ACTIVATE(32): all SWR to Conventional (zone addressing)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -z -32 ${device} ${domain_seq_start} ${nr_seq_zones}  "conv"
