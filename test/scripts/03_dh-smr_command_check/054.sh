...
zbc_test_init $0 "ZONE ACTIVATE(32): non-convertible Conventional to SWR (domain addressing)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -32 ${device} ${domain_num} 1 "seq"
