...
zbc_test_init $0 "ZONE ACTIVATE(16): SWR to Conventional (domain addressing, FSNOZ)" $*
...
# Find an SWR domain that is convertible to CMR
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -n ${device} ${domain_num} 1 "conv"
