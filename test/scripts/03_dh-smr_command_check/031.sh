...
zbc_test_init $0 "ZONE ACTIVATE(16): SWR to CMR (zone addressing)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -z ${device} $(zbc_realm_cmr_start) $(zbc_realm_cmr_len) ${cmr_type}
