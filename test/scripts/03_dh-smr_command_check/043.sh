...
zbc_test_init $0 "ZONE ACTIVATE(16): SWR to Conventional (zone addressing, FSNOZ)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -z -n ${device} ${domain_seq_start} ${domain_seq_len} "conv"
