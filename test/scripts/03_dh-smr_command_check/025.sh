...
zbc_test_init $0 "Convert a non-convertible SMR realm to CMR" $*
...
# Find the first SMR realm that is not convertible to SMR
zbc_test_search_realm_by_type_and_cvt "2" "noconv"
if [ $? -ne 0 ]; then
