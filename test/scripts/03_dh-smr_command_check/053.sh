...
zbc_test_init $0 "ZONE ACTIVATE(32): all SWR to Conventional (domain addressing)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -32 ${device} ${domain_num} ${nr_cvt_to_conv_domains} "conv"
