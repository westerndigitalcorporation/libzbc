...
zbc_test_init $0 "ZONE ACTIVATE(32): all SMR to CMR (realm addressing)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -32 ${device} ${realm_num} ${nr_actv_as_conv_realms} ${cmr_type}
