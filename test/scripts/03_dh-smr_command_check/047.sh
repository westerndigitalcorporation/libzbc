...
zbc_test_init $0 "ZONE ACTIVATE(16): non-activation SMR to CMR (zone addr, FSNOZ)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -z -n ${device} $(zbc_realm_cmr_start) $(zbc_realm_cmr_len) ${cmr_type}
if [ $? -eq 2 ]; then
