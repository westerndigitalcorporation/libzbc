...
zbc_test_init $0 "ZONE ACTIVATE(16): non-convertible Conventional to SWR (zone addressing)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -z ${device} ${domain_conv_start} ${domain_conv_len} "seq"
