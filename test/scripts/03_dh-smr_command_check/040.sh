...
zbc_test_init $0 "ZONE ACTIVATE(16): non-convertible CMR to SMR (realm addr, FSNOZ)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -n ${device} ${realm_num} 1 ${smr_type}
