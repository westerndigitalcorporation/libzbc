...
zbc_test_init $0 "ZONE ACTIVATE(32): CMR to SMR (zone addressing)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -z -32 ${device} $(zbc_realm_smr_start) $(zbc_realm_smr_len) ${smr_type}
