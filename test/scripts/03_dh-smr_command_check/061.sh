...
zbc_test_init $0 "ZONE ACTIVATE(32): SWR to CMR (zone addressing)" $*
...
# Find a SWR domain that is convertable to CMR
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_zone_activate -v -z -32 ${device} ${domain_seq_start} ${domain_seq_len} ${cmr_type}
