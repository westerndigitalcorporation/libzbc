...
zbc_test_init $0 "MEDIA_CONVERT(16) all domains to SMR (zone addressing)" $*
...
# Start testing
zbc_test_run ${bin_path}/zbc_test_media_convert -v -z ${device} ${domain_conv_start} ${nr_conv_zones} "seq"
